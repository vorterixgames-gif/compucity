...
export const BRAND_PATTERNS: BrandPattern[] = [
  ...
  { name: 'Kingston', slug: 'kingstontechnology', pattern: /\bKINGSTON\b|\bFURY\b|\bDATATRAVELER\b|\bDATA TRAVELER\b|\bA400\b|\bKC3000\b|\bKC600\b|\bDC600\b|\bNV3\b/i },
  { name: 'Corsair', slug: 'corsair', pattern: /\bCORSAIR\b|\bVENGEANCE\b|\bK70\b|\bK95\b/i },
  { name: 'Samsung', slug: 'samsung', pattern: /\bSAMSUNG\b|\bODYSSEY\b|\bVIEWFINITY\b|\bEVO\b/i },
  { name: 'Seagate', slug: 'seagate', pattern: /\bSEAGATE\b|\bBARRACUDA\b|\bIRONWOLF\b|\bSKYHAWK\b|\bFIRECUDA\b|\bEXPANSION\b|\bONE TOUCH\b/i },
  { name: 'WD', slug: 'wd', pattern: /\bWESTERN\b|\bWD[A-Z]|\bWD\b|\bMY PASSPORT\b|\bELEMENTS\b|\bBLUE\b|\bBLACK\b|\bGOLD\b|\bRED\b|\bPURPLE\b/i },
  ...
  { name: 'Crucial', slug: 'crucial', pattern: /\bCRUCIAL\b|\bBX500\b|\bP310\b|\bE100\b|\bX9\b|\bX8\b/i },
  ...
  { name: 'Team Group', slug: 'team-group', pattern: /\bTEAM\s*GROUP\b/i },
  { name: 'Biwin', slug: 'biwin', pattern: /\bBIWIN\b/i },
  { name: 'Cooler Master', slug: 'cooler-master', pattern: /\bCOOLER\s*MASTER\b|\bCM\s*(MASTER|ML|MF)/i },
  { name: 'Thermaltake', slug: 'thermaltake', pattern: /\bTHERMALTAKE\b|\bTT\b|\bTt\s*(CT|Liquid|LA|Ring|SWAFAN)/i },
  ...
  { name: 'Seasonic', slug: 'seasonic', pattern: /\bSEASONIC\b|\bFOCUS\b/i },
  ...
  { name: 'LG', slug: 'lg', pattern: /\bLG\b|\bULTRAGEAR\b/i },
  ...
  { name: 'TP-Link', slug: 'tp-link', pattern: /\bTP[\s\-]?LINK\b|\bARCHER\b|\bDECO\b|\bTL\s*W\b|\bTAPO\b/i },
  ...
  { name: 'D-Link', slug: 'd-link', pattern: /\bD[\s\-]?LINK\b/i },
  ...
  { name: 'Harman Kardon', slug: 'harman-kardon', pattern: /\bHARMAN\b|\bKARDON\b/i },
  ...
  { name: 'Xiaomi', slug: 'xiaomi', pattern: /\bXIAOMI\b|\bMI\b|\bROBOROCK\b/i },
  ...
  { name: 'APC', slug: 'apc', pattern: /\bAPC\b/i },
  ...
  { name: 'Performance', slug: 'performance', pattern: /\bPERFORMANCE\b/i },
  { name: 'Motorola', slug: 'motorola', pattern: /\bMOTOROLA\b/i },
  { name: 'Bags', slug: 'bags', pattern: /\bBAGS\b/i },
]
