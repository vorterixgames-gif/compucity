...
const CATEGORY_FILTERS: Record<string, CategoryFilterOption[]> = {
  ...
  'oficina': [
    { key: 'brand', label: 'HP', value: 'HP', matchFn: (n) => /\bHP\b/i.test(n) },
    { key: 'brand', label: 'Lenovo', value: 'LENOVO', matchFn: (n) => /\bLENOVO\b|\bTHINKPAD\b|\bIDEAPAD\b/i.test(n) },
    { key: 'brand', label: 'Dell', value: 'DELL', matchFn: (n) => /\bDELL\b|\bINSPIRON\b|\bLATITUDE\b|\bVOSTR0\b/i.test(n) },
  ...
  'gamer-y-diseno': [
    { key: 'brand', label: 'HP', value: 'HP', matchFn: (n) => /\bHP\b|\bOMEN\b|\bVICTUS\b/i.test(n) },
    ...
    { key: 'brand', label: 'Samsung', value: 'SAMSUNG', matchFn: (n) => /\bSAMSUNG\b|\bGALAXY\s*BOOK\b/i.test(n) },
  ],
}
