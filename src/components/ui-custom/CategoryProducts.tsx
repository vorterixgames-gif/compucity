...
const CATEGORY_FILTERS: Record<string, CategoryFilterOption[]> = {
  ...
  'memorias-ram': [
    ...
    { key: 'ddr', label: 'DDR4', value: 'DDR4', matchFn: (n) => /\bDDR4\b/i.test(n) },
    { key: 'ddr', label: 'DDR5', value: 'DDR5', matchFn: (n) => /\bDDR5\b/i.test(n) },
    { key: 'capacity', label: '4GB', value: '4gb', matchFn: (n) => /\b4\s*GB\b/i.test(n) },
  ...
  'placas-de-video': [
    ...
    { key: 'vram', label: '32GB', value: '32gb', matchFn: (n) => /\b32\s*GB\b/i.test(n) && /\bRTX\b|\bGTX\b|\bRADEON\b|\bGEFORCE\b|\bQUADRO\b/i.test(n) },
  ...
  'notebooks': [
    ...
    { key: 'brand', label: 'CX', value: 'CX', matchFn: (n) => /\bCX\b/i.test(n) },
    { key: 'brand', label: 'Kelyx', value: 'KELYX', matchFn: (n) => /\bKELYX\b/i.test(n) },
    { key: 'processor', label: 'Intel', value: 'INTEL', matchFn: (n) => /\bI[3579]\b|\bINTEL\b|\bCORE\s*[57]|\bCELERON\b|\bPENTIUM\b|\bU[57]-?\d/i.test(n) },
    { key: 'processor', label: 'AMD', value: 'AMD', matchFn: (n) => /\bRYZEN\b|\bAMD\b|\bR[357]-\d/i.test(n) },
    { key: 'ram', label: '4GB', value: '4gb', matchFn: (n) => /\b4\s*GB\b/i.test(n) },
    { key: 'ram', label: '8GB', value: '8gb', matchFn: (n) => /\b8\s*GB\b/i.test(n) },
    { key: 'ram', label: '16GB', value: '16gb', matchFn: (n) => /\b16\s*GB\b/i.test(n) },
    { key: 'ram', label: '24GB', value: '24gb', matchFn: (n) => /\b24\s*GB\b/i.test(n) },
    { key: 'ram', label: '32GB', value: '32gb', matchFn: (n) => /\b32\s*GB\b/i.test(n) },
  ...
  'memoria-ram-notebook': [
    ...
    { key: 'capacity', label: '8GB', value: '8gb', matchFn: (n) => /\b8\s*GB\b/i.test(n) },
    { key: 'capacity', label: '16GB', value: '16gb', matchFn: (n) => /\b16\s*GB\b/i.test(n) },
    { key: 'capacity', label: '24GB', value: '24gb', matchFn: (n) => /\b24\s*GB\b/i.test(n) },
    { key: 'capacity', label: '32GB', value: '32gb', matchFn: (n) => /\b32\s*GB\b/i.test(n) },
    { key: 'capacity', label: '48GB+', value: '48gbplus', matchFn: (n) => { const m = n.match(/\b(\d+)\s*GB\b/i); return m ? parseInt(m[1]) >= 48 : false } },
  ],
  'fundas-mochilas': [
  ...
  'micro-sd': [
    ...
    { key: 'brand', label: 'Lexar', value: 'LEXAR', matchFn: (n) => /\bLEXAR\b/i.test(n) },
    { key: 'capacity', label: '32GB', value: '32gb', matchFn: (n) => /\b32\s*GB\b/i.test(n) },
    { key: 'capacity', label: '64GB', value: '64gb', matchFn: (n) => /\b64\s*GB\b/i.test(n) },
    { key: 'capacity', label: '128GB', value: '128gb', matchFn: (n) => /\b128\s*GB\b/i.test(n) },
    { key: 'capacity', label: '256GB', value: '256gb', matchFn: (n) => /\b256\s*GB\b/i.test(n) },
    { key: 'capacity', label: '512GB+', value: '512gbplus', matchFn: (n) => { const m = n.match(/\b(\d+)\s*GB\b/i); return m ? parseInt(m[1]) >= 512 : false } },
  ],
  'hogar-inteligente': [
  ...
  'pc-armadas': [
    { key: 'brand', label: 'HP', value: 'HP', matchFn: (n) => /\bHP\b|\bZ1G\b|\bZ2G\b/i.test(n) },
    { key: 'brand', label: 'CX', value: 'CX', matchFn: (n) => /\bCX\b/i.test(n) },
    { key: 'brand', label: 'Gamemax', value: 'GAMEMAX', matchFn: (n) => /\bGAMEMAX\b/i.test(n) },
    { key: 'brand', label: 'Lenovo', value: 'LENOVO', matchFn: (n) => /\bLENOVO\b/i.test(n) },
  ],
  ...
  'mini-pc': [
    { key: 'brand', label: 'ASUS', value: 'ASUS', matchFn: (n) => /\bASUS\b|\bPN\d/i.test(n) },
    { key: 'brand', label: 'CX', value: 'CX', matchFn: (n) => /\bCX\b/i.test(n) },
    { key: 'brand', label: 'Lenovo', value: 'LENOVO', matchFn: (n) => /\bLENOVO\b|\bTHINKCENTRE\b/i.test(n) },
    { key: 'brand', label: 'HP', value: 'HP', matchFn: (n) => /\bHP\b|\bELITEDESK\b|\bPRODESK\b/i.test(n) },
    { key: 'brand', label: 'Intel', value: 'INTEL', matchFn: (n) => /\bINTEL\b|\bNUC\b/i.test(n) },
  ],
  'oficina-pc': [
    { key: 'brand', label: 'CX', value: 'CX', matchFn: (n) => /\bCX\b/i.test(n) },
    { key: 'brand', label: 'HP', value: 'HP', matchFn: (n) => /\bHP\b/i.test(n) },
    { key: 'brand', label: 'Lenovo', value: 'LENOVO', matchFn: (n) => /\bLENOVO\b|\bTHINKCENTRE\b|\bIDEACENTRE\b/i.test(n) },
    { key: 'brand', label: 'Dell', value: 'DELL', matchFn: (n) => /\bDELL\b|\bINSPIRON\b|\bOPTIPLEX\b/i.test(n) },
    { key: 'type', label: 'PC Escritorio', value: 'PC', matchFn: (n) => /\bPC\b|\bDESKTOP\b/i.test(n) && !/\bAIO\b|\bALL\s*IN\s*ONE\b/i.test(n) },
    { key: 'type', label: 'All in One', value: 'AIO', matchFn: (n) => /\bAIO\b|\bALL\s*IN\s*ONE\b/i.test(n) },
  ],
  'gamer-y-diseno': [
    ...
    { key: 'processor', label: 'Intel', value: 'INTEL', matchFn: (n) => /\bI[3579]\b|\bINTEL\b|\bCORE\s*[57]|\bU[57]-?\d/i.test(n) },
    { key: 'processor', label: 'AMD', value: 'AMD', matchFn: (n) => /\bRYZEN\b|\bAMD\b|\bR[357]-\d/i.test(n) },
    { key: 'ram', label: '8GB', value: '8gb', matchFn: (n) => /\b8\s*GB\b/i.test(n) },
    { key: 'ram', label: '16GB', value: '16gb', matchFn: (n) => /\b16\s*GB\b/i.test(n) },
    { key: 'ram', label: '24GB', value: '24gb', matchFn: (n) => /\b24\s*GB\b/i.test(n) },
    ...
    { key: 'gpu', label: 'Otras', value: 'other_gpu', matchFn: (n) => /\bRTX\b|\bGTX\b/i.test(n) && !/RTX\s*(5060|5050|4050|3050|1000|2000)/i.test(n) },
  ],
}
