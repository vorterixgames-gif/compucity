...
export default function NotebookChatBanner() {
  ...
  return (
    <div className="mb-6 rounded-2xl overflow-hidden bg-gradient-to-r from-compucity-green-600 via-compucity-green-700 to-compucity-green-800 text-white relative">
      {/* Background decoration */}
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <div className="absolute -top-8 -right-8 w-48 h-48 bg-white rounded-full blur-2xl" />
        <div className="absolute -bottom-8 -left-8 w-36 h-36 bg-compucity-green-300 rounded-full blur-2xl" />
      </div>
      ...
      <div className="relative z-10 flex items-center gap-4 px-5 py-4 md:px-6 md:py-5">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-0.5">
            ...
            <span className="text-xs font-medium text-compucity-green-200 uppercase tracking-wide">Asistente inteligente</span>
          </div>
          <h3 className="text-base md:text-lg font-bold leading-tight">
            ¿No sabés cuál elegir? Hablá con Citi
          </h3>
          <p className="text-sm text-compucity-green-100 mt-0.5 hidden sm:block">
        ...
        <button
          onClick={openChat}
          className="shrink-0 flex items-center gap-2 px-4 py-2.5 md:px-5 md:py-3 bg-white text-compucity-green-700 rounded-xl font-semibold text-sm hover:bg-compucity-green-50 transition-all shadow-lg hover:shadow-xl active:scale-95"
        >
