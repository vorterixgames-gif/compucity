    ...
    <section className="py-10">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/categoria/todos" className="hidden sm:inline-flex items-center gap-1 text-sm text-compucity-green hover:text-compucity-green-dark font-semibold group transition">
          ...
          {displayCategories.map((cat) => {
            ...
            return (
              <Link
                key={catId}
                href={`/categoria/${slug}`}
                className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white border border-gray-200 hover:border-compucity-green/30 card-hover group"
              >
                <div className="p-3 rounded-xl bg-compucity-green-50 group-hover:bg-compucity-green transition-colors duration-200">
                  <Icon className="h-5 w-5 text-compucity-green group-hover:text-white transition-colors duration-200" />
                </div>
                <span className="text-xs font-semibold text-gray-600 group-hover:text-compucity-green text-center transition-colors line-clamp-2">
                  {cat.name}
                </span>
              </Link>
            )
