        ...
        <div className="md:hidden bg-white border-b border-gray-200 max-h-[70vh] overflow-y-auto animate-slide-up">
          ...
          <div className="border-t border-gray-100">
            <Link href="/categoria/todos" className="flex items-center gap-2 px-5 py-3.5 text-sm font-bold text-compucity-green hover:bg-compucity-green-50 transition" onClick={() => setMobileMenuOpen(false)}>
              <Menu className="h-4 w-4" /> Ver todas las categorías
            </Link>
          </div>
          <div className="p-4 border-t border-gray-100">
            <a href="https://wa.me/5493517656918?text=Hola!%20Quisiera%20hacer%20una%20consulta" target="_blank" className="flex items-center justify-center gap-2 w-full py-3 bg-compucity-green hover:bg-compucity-green-dark text-white rounded-lg font-medium transition">
