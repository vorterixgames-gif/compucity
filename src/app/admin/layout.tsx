...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      ...
      {/* Main Content */}
      <div id="admin-main-content" className="lg:pl-64 flex-1 flex flex-col min-h-screen w-0 min-w-0">
        {/* Top Bar */}
        ...
        {/* Page Content */}
        <main className="flex-1 p-4 lg:p-6 w-0 min-w-0 overflow-hidden">
          {children}
        </main>
      </div>
    </div>
