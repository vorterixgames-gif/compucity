...
const BUILDER_EXCLUDE_PATTERNS: Record<string, string[]> = {
  ...
  psu: ['MAENI', '5V CARGA', 'DE ALIMENTACION', 'DE EPL', 'REDUNDANTE', 'AUXILIAR', 'LENOVO', 'ENCHUFE', 'HP FUENTE REDUNDANTE', 'HP RPS', 'HPX311', 'NOTEBOOK', 'LAPTOP', 'PC GAMER', 'PC KELYX', 'PC LENOVO', 'SIST.', 'MINI PC', 'BAREBONE'],
  ...
  network: ['NOTEBOOK', 'LAPTOP', 'SWITCH', 'ROUTER', 'ACCESS POINT', 'FIREWALL', 'SFP', 'FIBRA', 'FTTH', 'ONT', 'HUB ', 'MODEM', 'PC GAMER', 'PC KELYX', 'PC LENOVO', 'SIST.', 'MINI PC', 'BAREBONE', 'CABLE', 'PATCH', 'RACK', 'ROLLO', 'FICHA', 'UTP', 'MEDIA CONVERTER', 'MODULO SFP', 'CAMARA', 'CAMARA IP', 'DECO ', 'MESH', 'TAPO C', 'CPE ', 'RANGE EXTENDER', 'A SD ', 'A MICRO SD', 'A HDMI', 'A DISPLAYPORT', 'A USB COMUN', 'USB-C A USB', 'CONTROLLER', 'CLOUD', 'JBL', 'FUENTE', 'OLP', 'PSM', 'PACK DE ', 'P/VOLANTE'],
  peripherals: ['NOTEBOOK', 'LAPTOP', 'HUB USB', 'EXTENSOR', 'ALMOHADILLA', 'MOUSEPAD', 'FUNDAS', 'BATERIA', 'CARGADOR', 'PC GAMER', 'PC KELYX', 'PC LENOVO', 'SIST.', 'MINI PC', 'BAREBONE', 'CABLE KELYX', 'CABLE HDMI', 'CABLE DISPLAY', 'CABLE USB', 'CABLE TYPE C', 'CABLE ADAPTADOR', 'CABLE DE RED', 'ADAPTADOR HDMI', 'ADAPTADOR VGA', 'ADAPTADOR KELYX', 'P/VOLANTE'],
}
...
const BUILDER_INCLUDE_PATTERNS: Record<string, string[]> = {
  processor: ['RYZEN', 'INTEL I3', 'INTEL I5', 'INTEL I7', 'INTEL I9', 'CORE I3', 'CORE I5', 'CORE I7', 'CORE I9', 'PENTIUM', 'CORE ULTRA', 'CELERO', 'ATHLON', 'XEON', 'I3-', 'I5-', 'I7-', 'I9-', 'CPU '],
  ...
  ram: ['DDR3', 'DDR4', 'DDR5', 'SODIMM', 'DIMM', 'MEMORIA RAM', 'CORSAIR VENGEANCE', 'CORSAIR MEMORY', 'KINGSTON FURY', 'G.SKILL', 'XPG', 'RAM'],
